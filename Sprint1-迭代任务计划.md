...
#### T002-2: 登出API调用（开发者A，0.5h）
**描述**: 前端调用登出接口
**验收标准**:
- [ ] POST请求到/api/v1/auth/logout
- [ ] 清除localStorage中的token
- [ ] 跳转到登录页

#### T002-3: 登出接口实现（开发者B，1h）
...
#### T004-2: V2__init_data.sql（开发者B，1h）
**描述**: 创建初始数据脚本
**验收标准**:
- [ ] admin账号（密码BCrypt加密）
- [ ] designer账号
...
#### T004-3: 数据库初始化验证（开发者B，0.5h）
**描述**: 验证Flyway迁移成功
**验收标准**:
- [ ] SQLite数据库文件创建
- [ ] 6张表全部存在
- [ ] flyway_schema_history包含2条记录
- [ ] users表包含3条测试账号
