...
- 🚀 **Sprint 1** (34%) - 基础设施完成，US001登录功能完成 (当前Sprint)
...
- [ ] **T005-1**: 用户列表页面（开发者A，2h）- 表格展示，操作按钮
- [ ] **T005-2**: 创建用户对话框（开发者A，2h）- 表单验证，密码强度检查
- [ ] **T005-3**: 编辑用户对话框（开发者A，1.5h）- 加载用户数据，更新表单
- [ ] **T005-4**: 用户CRUD API（开发者B，4h）- GET/POST/PUT/DELETE接口
- [ ] **T005-5**: UserService（开发者B，3h）- 业务逻辑，BCrypt密码加密
- [ ] **T005-6**: 用户管理测试（开发者A+B，3.5h）- E2E测试，单元测试
